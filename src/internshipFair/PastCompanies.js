...
const PastCompanies = () => {
  return (
    ...
    >
      ...
      >
        <SwiperSlide>
          <img src={wiseidot} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={yocket} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={spacenos} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={skyindya} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={prixled} alt="" />
        </SwiperSlide>
        ...
        <SwiperSlide>
          <img src={cyberfrat} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={boson} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={birthvenue} alt="" />
        </SwiperSlide>
        <SwiperSlide>
          <img src={confluencr} alt="" />
        </SwiperSlide>
      </Swiper>
    </div>
  );

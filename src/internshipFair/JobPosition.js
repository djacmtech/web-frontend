      ...
      >
        <Card sx={{ padding: "0% 2%" }}>
          <CardContent>
            ...
            <div>
              <div className="jobtitle" style={{paddingTop:"2rem"}}>About the Company</div>
              <div>
            ...
            <div style={{ display: "flex", padding:"1.5rem 1.5rem 1rem 1.5rem",color:"#187271", fontWeight:"600" }}>
            ...
            <div style={{paddingBottom:"1rem"}}>
              ...
              <ol type="1" style={{paddingInlineStart:"18px", marginBlockStart:"0"}}>
                <li>are available for the work from home job/internship</li>
                <li>
                  can start the work from home job/internship between 1st Apr'22
                  and 6th May'22

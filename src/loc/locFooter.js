...
const LocFooter = () => {
  const pages = ["Prizes", "Domain", "Timeline", "Guidelines", "Sponsors", "FAQS"];
  return (
    <div
      style={{
        paddingTop: "20px",
      ...
      <center>
        <Grid container className='locNav' spacing={3}>
          <Grid item sm={3} xs={12}>
            ...
            <img
              ...
              src={image}
              alt='logo'
              style={{ transform: "translateX(-10px)" }}></img>
            <h6 className='aboutFooter'>
              Don't let us convince you about our success. Let our three consecutive Best Student
              Chapter of the Year awards do the talking.
            </h6>
          </Grid>
          <Grid item sm={3} xs={12}>
            <p>Navigation</p>
          ...
          <Grid item sm={3} xs={12}>
            ...
            <h6 className='locationData'>
              No. U, 15, Bhaktivedanta Swami Rd, opp. Cooper Hospital, JVPD Scheme, Vile Parle,
        ...
        <h4 style={{ padding: "0 0 1.5% 0", marginBottom: "0" }}>

...
function Faqs() {
    ...
    return (
        <div id='FAQS' style={{ color: 'black', backgroundColor: '#001522', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', fontSize: '18px' }}>
            <h1 style={{ color: 'white', fontFamily: 'Righteous', padding:'0 2% 0 2%'}} data-aos="fade-left"> Frequently Asked Questions </h1>
            ...
            <div style={{ width: '70%', paddingBottom:'5%', paddingTop:'2%'}}>
                ...
                <Accordion defaultExpanded={true}>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                    >
                        <Typography style={{ fontFamily: 'Montserrat', color:'#FFFFFF' }} variant="h6">What is a hackathon?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                ...
                <Accordion style={{paddingBlock:'2%'}} >
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography style={{ fontFamily: 'Montserrat', color:'#FFFFFF'}} variant="h6">What are the problem statements for the hackathon?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                ...
                <Accordion style={{paddingBlock:'2%'}} >
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography style={{ fontFamily: 'Montserrat', color:'#FFFFFF' }} variant="h6">What will be the mode and location of the hackathon?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography style={{ textAlign: 'left', fontFamily: 'Montserrat', color:'white' }}>
                ...
                <Accordion style={{paddingBlock:'2%'}} >
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography style={{ fontFamily: 'Montserrat', color:'#FFFFFF' }} variant="h6">What are the eligibility criteria? Are there any prerequisites or</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography style={{ textAlign: 'left', fontFamily: 'Montserrat', color:'white' }}>
                ...
                <Accordion style={{paddingBlock:'2%'}} >
                    <AccordionSummary
                        ...
                        id="panel2a-header"
                    >
                        <Typography style={{ fontFamily: 'Montserrat', color:'#FFFFFF' }} variant="h6">How much does this cost?</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                        <Typography style={{ textAlign: 'left', fontFamily: 'Montserrat', color:'white' }}>

                ...
                <div data-aos="fade-up">
                    <Accordion style={{ paddingBlock: '2%' }} >
                        <AccordionSummary
                            ...
                            id="panel2a-header"
                        >
                            <Typography style={{ fontFamily: 'Montserrat', color: '#FFFFFF', fontWeight: 'bold' , textAlign: 'left' }} variant="h6">Can I start working on my submission before the event or use something that I have built previously?</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Typography style={{ textAlign: 'left', fontFamily: 'Montserrat', color: 'white' }}>

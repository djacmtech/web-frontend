          ...
          <Accordion defaultExpanded={true}>
            ...
            <AccordionDetails>
              <Typography
                ...
                A hackathon is a social coding event where programmers, designers and developers
                collaborate to solve a problem and compete for prizes.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>
          ...
          <Accordion style={{ paddingBlock: "2%" }}>
            ...
            <AccordionDetails>
              <Typography
                ...
                The problem statements will be declared soon. Once you&#39;ve registered we&#39;ll
                keep you posted with all details.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>
          ...
          <Accordion style={{ paddingBlock: "2%" }}>
            ...
            <AccordionDetails>
              <Typography
                ...
                This competition is open to all university students so do send in your application
                to attend ! While experience in programming and software development is beneficial,
                this can be a great opportunity to network and learn.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>
          ...
          <Accordion style={{ paddingBlock: "2%" }}>
            <AccordionSummary
              ...
              <Typography
                ...
                variant='h6'>
                Can I start working on my submission before the event or use something that I have
                built previously?
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography
                ...
                The submission for LoC has to be made during the duration of the event in its
                entirety. Using prior work can lead to disqualification.
              </Typography>
            </AccordionDetails>
          </Accordion>
        </div>

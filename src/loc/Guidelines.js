...
function Guidelines() {
  ...
  return (
    <div
      ...
      style={{ color: "black", backgroundColor: "#001522", padding: "0 8%", marginBottom: "4%" }}>
      <center>
        ...
        <Grid container columnSpacing={1} rowSpacing={8}>
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Registration will be done through Devfolio. All teams must also submit their team
                for review.
              </p>
            </div>
          </Grid>
          ...
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Teams will be shortlisted on the basis of their Devfolio profile.
              </p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Every shortlisted team must RSVP on Devfolio for their team to participate in the
                hackathon.
              </p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Each team should provide the new GitHub link of their project at the start of the
                hackathon.
              </p>
            </div>
          </Grid>
          ...
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Problem statement will be released prior to the event and teams have to work on only
                one PS.
              </p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Plagiarism/clones of the project are strictly prohibited.
              </p>
            </div>
          </Grid>
          <Grid item lg={4} md={6} sm={6} xs={12}>
            <div data-aos='fade-up' className='guidelines'>
              ...
              <br />
              <p className='guideContain'>
                Mentoring and assistance will be provided during the hackathon.
              </p>
            </div>
          </Grid>
        </Grid>

        ...
        <div style={{  background: "linear-gradient(179.94deg, #FF8A50 -1.24%, #F54951 64.13%)" }}>
            <Grid container spacing={2}>
                <Grid item xs={12} md={5} columnGap={2} style={{padding:"2%", textAlign:"center"}}>
                    ...
                    <div style={{fontFamily:'montserrat', fontSize:'17px'}}>
                        <p> <h2> EMAIL </h2> 
                        <div style={{display:'flex', flexDirection:'row', justifyContent:'center', alignContent:'center', alignItems:'center', padding:'3px'}}> 
                            <div> <AiFillMail style={{fontSize:'30px'}}/> </div>
                            <div style={{paddingLeft:'20px', fontSize:'20px'}}> coreacm@gmail.com </div>
                        </div> 
                        </p>
                        <p> <h2> PHONE </h2> Richa Shah | 9892993784 <br/> Richa Shah | 9892993784 </p>
                        <p> <h2> SOCIALS </h2> 
                        <div style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                            <div> <BsGlobe2 style={{fontSize:'35px', color:'black', padding:'3px 8px 3px 8px'}}/> </div> 
                            <div> <AiFillInstagram style={{fontSize:'40px', color:'black', padding:'3px 8px 3px 8px'}}/> </div>
                            <div> <AiFillLinkedin style={{fontSize:'40px', color:'black', padding:'3px 8px 3px 8px'}}/> </div>
                            <div> <AiFillFacebook style={{fontSize:'40px', color:'black', padding:'3px 8px 3px 8px'}}/> </div>
                        </div>
                        </p> 
                    </div>
                </Grid>
                <Grid item xs={12} md={7} style={{display:'flex', alignItems:'center', justifyContent:'center'}}>
                    ...
                    loading="lazy"
                    style={{height:"500px", width:'600px', padding:'5% 10% 5% 0'}}
                    />
                </Grid>
            </Grid>
        </div>
